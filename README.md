...
| Campo | Información |
|-------|-------------|
| Nombre completo | Fatima Geraldine Saenz Holguin |
| Número de control | 24308051220648 |
| Grupo | G |
| Grado | 4 |
| Escuela | Centro de bachillerato tecnologico y de servicios 122 |
| Especialidad | Programacion |

## 📘 Información del Ejercicio
- Título del ejercicio: Problemas secuenciales
- Descripción:
Crear una pagina con 10 problemas:
